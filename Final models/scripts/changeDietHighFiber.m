function [modelJointHighFiber]=changeDietHighFiber(modelJoint)
...
% sugars
modelJoint=changeRxnBounds(modelJoint,{'EX_fru[u]';'EX_glc-D[u]';'EX_gal[u]';'EX_man[u]'},-0.06250,'l');
modelJoint=changeRxnBounds(modelJoint,{'EX_lcts[u]';'EX_malt[u]';'EX_sucr[u]';'EX_melib[u]'},-0.03125,'l');
modelJoint=changeRxnBounds(modelJoint,'EX_strch1[u]',-0.04545,'l');
% fibers
modelJoint=changeRxnBounds(modelJoint,'EX_inulin[u]',-0.015278,'l');
modelJoint=changeRxnBounds(modelJoint,'EX_levan1000[u]',-0.000458,'l');
modelJoint=changeRxnBounds(modelJoint,{'EX_starch1200[u]'},-0.000382,'l');
modelJoint=changeRxnBounds(modelJoint,'EX_arabinogal[u]',-0.000712,'l');
modelJoint=changeRxnBounds(modelJoint,'EX_pect[u]',-0.001085,'l');
modelJoint=changeRxnBounds(modelJoint,'EX_pullulan1200[u]',-0.000382,'l');
modelJoint=changeRxnBounds(modelJoint,'EX_amylose300[u]',-0.015278,'l');
modelJoint=changeRxnBounds(modelJoint,'EX_lmn30[u]',-0.015278,'l');
modelJoint=changeRxnBounds(modelJoint,'EX_raffin[u]',-0.152778,'l');
modelJoint=changeRxnBounds(modelJoint,'EX_stys[u]',-0.114583,'l');
modelJoint=changeRxnBounds(modelJoint,'EX_oligofru4[u]',-0.114583,'l');
modelJoint=changeRxnBounds(modelJoint,'EX_dextran40[u]',-0.005729,'l');
% fat
...
modelJoint = changeRxnBounds(modelJoint,'IECIEX_o2[u]tr',0,'b');

modelJoint=changeRxnBounds(modelJoint,{'EX_o2[u]'},-10,'l');


modelJointHighFiber=modelJoint;
